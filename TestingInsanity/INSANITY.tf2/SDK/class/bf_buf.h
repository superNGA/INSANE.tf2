/*
* STRAIGHT UP --YANKED-- FROM AMALGUN & TF2 SOURCE.
* NOT A SINGLE SHIT WORTH OF EFFORT DONE HERE. 
* what else do you expect me to do, write 2200 lines of code to 
* get some stupid server engine time? HUH !? FUCK YOU!
*/
...
public:
	...
	void			WriteBitVec3Coord(const vec& fa);
	void			WriteBitNormal(float f);
	void			WriteBitVec3Normal(const vec& fa);
	void			WriteBitAngles(const vec& fa);
...
public:
	...
	float			ReadBitFloat();
	float			ReadBitNormal();
	void			ReadBitVec3Coord(vec& fa);
	void			ReadBitVec3Normal(vec& fa);
	void			ReadBitAngles(vec& fa);
