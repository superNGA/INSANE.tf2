...
// Player esp settings.
DEFINE_FEATURE(ESPPlayer_Enable,                "ESP",                       bool,          Player, Materials, 4, false, FeatureFlag_None, "Enable esp boxes")
DEFINE_FEATURE(ESPPlayer_ESPColorTopLeft,       "Top-Left clr",              ColorData_t,   Player, Materials, 5, ColorData_t(1.0f, 1.0f, 1.0f, 1.0f))
DEFINE_FEATURE(ESPPlayer_ESPColorTopRight,      "Top-Right clr",             ColorData_t,   Player, Materials, 6, ColorData_t(1.0f, 1.0f, 1.0f, 1.0f))
DEFINE_FEATURE(ESPPlayer_ESPColorBottomLeft,    "Bottom-Left clr",           ColorData_t,   Player, Materials, 7, ColorData_t(1.0f, 1.0f, 1.0f, 1.0f))
DEFINE_FEATURE(ESPPlayer_ESPColorBottomRight,   "Bottom-Right clr",          ColorData_t,   Player, Materials, 8, ColorData_t(1.0f, 1.0f, 1.0f, 1.0f))
DEFINE_FEATURE(ESPPlayer_RGB,                   "RGB",                       FloatSlider_t, Player, Materials, 9, FloatSlider_t(-1.0f,   -1.0f,  10.0f), FeatureFlag_None, "RGB esp boxes")
DEFINE_FEATURE(ESPPlayer_HeightOffset,          "Height Offset",             FloatSlider_t, Player, Materials, 10, FloatSlider_t( 0.0f, -200.0f, 200.0f), FeatureFlag_None, "Don't like box's height? change it.")
DEFINE_FEATURE(ESPPlayer_WidthOffset,           "Width Offset",              FloatSlider_t, Player, Materials, 11, FloatSlider_t( 0.0f, -200.0f, 200.0f), FeatureFlag_None, "I'm pretty sure that this box is thicker than you, but anyways.")
DEFINE_FEATURE(ESPPlayer_DrawHitbox,            "Draw Hitboxes",             bool,          Player, Materials, 12, false, FeatureFlag_None, "Enable esp boxes")
DEFINE_FEATURE(ESPPlayer_DrawSkeleton,          "Draw Skeleton",             bool,          Player, Materials, 13, false, FeatureFlag_None, "Enable esp boxes")
DEFINE_FEATURE(ESPPlayer_SkeletonRGB,           "Skeleton RGB",              FloatSlider_t, Player, Materials, 14, FloatSlider_t(-1.0f,   -1.0f,  10.0f), FeatureFlag_None, "RGB Skeletons")
DEFINE_FEATURE(ESPPlayer_ExtraColorTopLeft,     "Skeleton Top-Left clr",     ColorData_t,   Player, Materials, 15, ColorData_t(1.0f, 1.0f, 1.0f, 1.0f))
