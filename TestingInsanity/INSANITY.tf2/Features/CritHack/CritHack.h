...
DEFINE_FEATURE(CritHack,          "CritHack", bool, CritHack, CritHack, 1,      false,              FeatureFlags::FeatureFlag_SupportKeyBind, "Forces crit seeds when shooting")
DEFINE_FEATURE(Always_Crit_Melee, "Always Crit Melee", bool, CritHack, CritHack, 2,      false,              FeatureFlag_SupportKeyBind,               "All Melee Swings will be crit")
DEFINE_FEATURE(Draw_Info,         "Draw Info", bool, CritHack, CritHack, 3,      false,              FeatureFlag_None,                         "Draws Crit-Ban status, Crit-Hack Status")
DEFINE_FEATURE(Draw_Debug_Info,   "Draw Debug Info", bool, CritHack, CritHack, 4,      false,              FeatureFlag_None,                         "Draws Debug Related Info")
