...
void CritHack_t::_Draw(CritBanStatus_t iBanStatus, CritHackStatus_t iCritHackStatus, WeaponCritData_t* pWeaponCritData, int iPendingDamage)
{
    ...
    if (Features::CritHack::CritHack::Draw_Info.IsActive() == true)
    {
        ...
        Render::infoWindowV2.AddOrUpdate("CritHack", "Crits Left", 0, InfoWindowWidget_t::Alignment_Left);
        Render::infoWindowV2.AddOrUpdate("CritHack", 
            std::format("{} / {}", 
        ...
        case CritHack_t::CRIT_ALLOWED:
            Render::infoWindowV2.AddOrUpdate("CritHack", "Crits Allowed", 1, InfoWindowWidget_t::Alignment_Middle);
            //Render::InfoWindow.AddToCenterConsole("Ban Status", "CRIT-ALLOWED", GREEN);
            break;
        case CritHack_t::CRIT_BANNED:
            Render::infoWindowV2.AddOrUpdate("CritHack", "Crits Banned", 1, InfoWindowWidget_t::Alignment_Middle);
        ...
        case CritHack_t::CRIT_TOO_EXPENSIVE:
            Render::infoWindowV2.AddOrUpdate("CritHack", "Too-Expensive", 1, InfoWindowWidget_t::Alignment_Middle);
