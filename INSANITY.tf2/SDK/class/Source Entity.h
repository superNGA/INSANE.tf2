...
public:
	...
	virtual c_baseentity_cleaned* GetBaseEntity() = 0;
...
class c_baseentity_cleaned : public I_client_entity
{
public:
	...
	virtual	c_baseentity_cleaned* GetBaseEntity();
